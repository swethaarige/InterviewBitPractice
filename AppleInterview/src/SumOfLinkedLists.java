...
public class SumOfLinkedLists {
    ...
    public LinkedList sumOfLinkedLists(LinkedList linkedListOne, LinkedList linkedListTwo) {
        LinkedList currentSumHeadPointerLinkedList = new LinkedList(0);
        LinkedList currentNode = currentSumHeadPointerLinkedList;
        int carry = 0;
        ...
        return currentSumHeadPointerLinkedList.next;
    }
}
